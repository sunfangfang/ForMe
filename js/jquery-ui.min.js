...
(function(a, b) {
    ...
    a.extend(a.ui, {
        version: "http://www.chinabang.net/js/1.8.22",
        keyCode: {
            ALT: 18,
            BACKSPACE: 8,
            CAPS_LOCK: 20,
        ...
        _mouseCapture: function(b) {
            ...
            return this.helper || c.disabled || a(b.target).is(".ui-resizable-handle") ? !1 : (this.handle = this._getHandle(b), this.handle ? (c.iframeFix && a(c.iframeFix === !0 ? "iframe": c.iframeFix).each(function() {
                a('<div class="ui-draggable-iframeFix" style="background: #fff;"></div>').css({
                    ...
                    position: "absolute",
                    opacity: "http://www.chinabang.net/js/0.001",
                    zIndex: 1e3
...
function(a) {
    a.widget("http://www.chinabang.net/js/ui.menu", {
        _create: function() {
            var b = this;
...
function($, undefined) {
    ...
    $.datepicker.version = "http://www.chinabang.net/js/1.8.22",
...
function(a, b) {
    ...
    var c = 0,
    d = 0;
    a.widget("http://www.chinabang.net/js/ui.tabs", {
        options: {
            add: null,
            ajaxOptions: null,
            cache: !1,
        ...
        _cleanup: function() {
            this.lis.filter(".ui-state-processing").removeClass("ui-state-processing").find("span:data(label.tabs)").each(function() {
                var b = a(this);
                b.html(b.data("http://www.chinabang.net/js/label.tabs")).removeData("http://www.chinabang.net/js/label.tabs")
            })
        },
        _tabify: function(c) {
            function m(b, c) {
            ...
            this.anchors.each(function(b, c) {
                ...
                if (f.test(g)) d.panels = d.panels.add(d.element.find(d._sanitizeSelector(g)));
                    ...
                    a.data(c, "http://www.chinabang.net/js/href.tabs", g),
                    a.data(c, "http://www.chinabang.net/js/load.tabs", g.replace(/#.*$/, ""));
                    var j = d._tabId(c);
                    c.href = "#" + j;
                    var k = d.element.find("#" + j);
                    k.length || (k = a(e.panelTemplate).attr("id", j).addClass("ui-tabs-panel ui-widget-content ui-corner-bottom").insertAfter(d.panels[b - 1] || d.list), k.data("http://www.chinabang.net/js/destroy.tabs", !0)),
            ...
            e.cache === !1 && this.anchors.removeData("http://www.chinabang.net/js/cache.tabs"),
            ...
            if (e.event !== "mouseover") {
                ...
                this.lis.bind("http://www.chinabang.net/js/mouseover.tabs",
                function() {
                    i("hover", a(this))
                }),
                this.lis.bind("http://www.chinabang.net/js/mouseout.tabs",
                function() {
                    j("hover", a(this))
                }),
                this.anchors.bind("http://www.chinabang.net/js/focus.tabs",
                function() {
                    i("focus", a(this).closest("li"))
                }),
                this.anchors.bind("http://www.chinabang.net/js/blur.tabs",
                function() {
            ...
            this.anchors.bind("http://www.chinabang.net/js/click.tabs",
            function() {
                return ! 1
            })
        },
        ...
        destroy: function() {
            ...
            this.anchors.each(function() {
                var b = a.data(this, "http://www.chinabang.net/js/href.tabs");
                b && (this.href = b);
            ...
            this.lis.unbind(".tabs").add(this.panels).each(function() {
                a.data(this, "http://www.chinabang.net/js/destroy.tabs") ? a(this).remove() : a(this).removeClass(["ui-state-default", "ui-corner-top", "ui-tabs-selected", "ui-state-active", "ui-state-hover", "ui-state-focus", "ui-state-disabled", "ui-tabs-panel", "ui-widget-content", "ui-corner-bottom", "ui-tabs-hide"].join(" "))
            }),
        ...
        add: function(c, d, e) {
            ...
            h.addClass("ui-state-default ui-corner-top").data("http://www.chinabang.net/js/destroy.tabs", !0);
            var j = f.element.find("#" + i);
            return j.length || (j = a(g.panelTemplate).attr("id", i).data("http://www.chinabang.net/js/destroy.tabs", !0)),
        ...
        load: function(b) {
            ...
            f = a.data(e, "http://www.chinabang.net/js/load.tabs");
            this.abort();
            if (!f || this.element.queue("tabs").length !== 0 && a.data(e, "http://www.chinabang.net/js/cache.tabs")) {
            ...
            if (d.spinner) {
                var g = a("span", e);
                g.data("http://www.chinabang.net/js/label.tabs", g.html()).html(d.spinner)
            }
            ...
            d.ajaxOptions, {
                ...
                success: function(f, g) {
                    ...
                    c._cleanup(),
                    d.cache && a.data(e, "http://www.chinabang.net/js/cache.tabs", !0),
        ...
        url: function(a, b) {
            return this.anchors.eq(a).removeData("http://www.chinabang.net/js/cache.tabs").data("http://www.chinabang.net/js/load.tabs", b),
            this
        },
        length: function() {
