...
(function(b) {
    b.fn.fullpage = function(c) {
        ...
        function u(a, e) {
            ...
            g.hasClass("active") && (c.loopHorizontal || (g.find("http://www.chinabang.net/js/.controlArrow.prev").toggle(0 != h), g.find("http://www.chinabang.net/js/.controlArrow.next").toggle(!e.is(":last-child"))), I(h, q, k));
        ...
        b(".section").each(function(a) {
            ...
            if (0 < d) {
                ...
                b(this).find("http://www.chinabang.net/js/.controlArrow.next").css("border-color", "transparent transparent transparent " + c.controlArrowColor);
                b(this).find("http://www.chinabang.net/js/.controlArrow.prev").css("border-color", "transparent " + c.controlArrowColor + " transparent transparent");
                c.loopHorizontal || b(this).find("http://www.chinabang.net/js/.controlArrow.prev").hide();
        ...
        function(a) {
            if (c.autoScrolling && B) {
                ...
                if (!k && !s) if (E = a.touches[0].pageY, y = a.touches[0].pageX, e.find(".slides").length && Math.abs(x - y) > Math.abs(D - E)) x > y ? e.find("http://www.chinabang.net/js/.controlArrow.next").trigger("click") : x < y && e.find("http://www.chinabang.net/js/.controlArrow.prev").trigger("click");
        ...
        b(document).keydown(function(a) {
            ...
            case 34:
                ...
                break;
            case 37:
                b(".section.active").find("http://www.chinabang.net/js/.controlArrow.prev").trigger("click");
                break;
            case 39:
                b(".section.active").find("http://www.chinabang.net/js/.controlArrow.next").trigger("click")
            }
        });
